...
export default function displayMenus() {
  document.getElementById('info').innerHTML = `
    <h1>Enjoy the gastronomy of the sea</h1>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="${image1}" class="d-block w-100" alt="food">
      <h4>Lorem Ipsum</h4>
    ...
    <div class="carousel-item">
      <img src="${image2}" class="d-block w-100" alt="food">
      <h4>Lorem Ipsum</h4>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five</p>
    </div>
    <div class="carousel-item">
      <img src="${image3}" class="d-block w-100" alt="food">
      <h4>Lorem Ipsum</h4>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five</p>
    </div>
    <div class="carousel-item">
      <img src="${image4}" class="d-block w-100" alt="food">
      <h4>Lorem Ipsum</h4>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five</p>
    </div>
  </div>
